...
- [ ] 사업자등록번호 (해당 시)
- [ ] 주소
- [x] 개인정보 보호 문의 이메일: vjsjv7003@naver.com
- [x] 고객지원 이메일: vjsjv7003@naver.com
- [x] 개인정보 기본 보유기간: 1년
- [ ] 안전한 본인확인 기반 회원 탈퇴/삭제 절차 구현
- [x] 현재 ONARIA가 직접 설정한 서버/AI·클라우드 기준 국외이전 없음
- [ ] 향후 해외 서비스 도입 확정 시 실제 이전 전 정책·Data Safety 재검토
- [ ] 만 14세 미만 이용 정책
- [ ] 분쟁/준거법/서비스 중단 안내
...
- Google Play 개발자 계정: vjsjsv7003@gmail.com
- Apple Developer Team/Account 정보
- 사업자등록번호·주소 등 실제 등록정보(해당 시)
- 고객지원/개인정보 문의 이메일
- 최종 무료/유료 정책
- Apple SKU
- 스토어 공개 국가/지역
...
- 해외 AI·클라우드 도입의 '런칭 후 약 6개월'은 외부 공개 약속이나 실제 국외이전 시작일이 아니라 내부 검토 기준일이다.
- 실제 도입 시점은 국내 서비스 운영 속도, 사용자 규모, 비용, 보안·법무 준비 상태에 따라 앞당겨지거나 늦춰질 수 있다.
- 실제 국외이전이 시작되기 전 개인정보 처리방침, Play Data Safety, Apple App Privacy 및 필요한 동의/고지를 현재 데이터 흐름과 일치하도록 갱신한다.
